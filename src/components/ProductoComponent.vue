                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12">
                                                <v-text-field v-model="editedItem.nombreProducto" label="Nombre Producto" variant="underlined"></v-text-field>
                                            </v-col>
                                            <v-col cols="12">
                                                <v-select v-model="editedItem.idCategoria" :items="categoriasOptions" label="Categoría" variant="underlined" v-bind:value="editedItem.idCategoria"></v-select>
                                            </v-col>
                                            <v-col cols="12">
                                                <v-text-field v-model="editedItem.descripcionProducto" label="Descripcion" variant="underlined"></v-text-field>
                                            </v-col>
                                            <v-col cols="6">
                                                <v-text-field v-model="editedItem.stock" label="Cantidad" variant="underlined"></v-text-field>
                                            </v-col>
                                            <v-col cols="6">
                                                <v-text-field v-model="editedItem.precio" label="Precio Unitario" variant="underlined"></v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-container>
                                </v-card-text>
